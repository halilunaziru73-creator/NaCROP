# PyInstaller spec for "NaCROP — Nigeria Irrigation DSS"
# Build with:  pyinstaller nacrop.spec
#
...
if sys.platform == "darwin":
    ...
    icon_file = None  # Linux: PyInstaller doesn't embed a binary icon; we set it at
                       ...
                       # (see nacrop-dss.desktop) point directly at the PNG instead.
...
if sys.platform == "darwin":
    app = BUNDLE(
        ...
        name="NaCROP.app",
        icon=icon_file,
        bundle_identifier="ng.nacrop.cropetirrigationdss",
        info_plist={
            "CFBundleName": "NaCROP — Nigeria Irrigation DSS",
